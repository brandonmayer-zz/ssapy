...
def condLocalLimitUpdate(bundles, revenue, bids, targetBid, samples, eps = 1e-5, verbose = False):
    """
...
def condLocalLimit(bundles, revenue, initialBids, samples, maxItr = 100, tol = 1e-5, 
